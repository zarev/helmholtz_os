...
#ros2 launch ur_mtc_pick_place_demo point_cloud_viewer.launch.py file_name:=/home/darsh/Downloads/4_convertToPCL_debug_cloud.pcd

# See the support plane that was extracted from the point cloud
#ros2 launch ur_mtc_pick_place_demo point_cloud_viewer.launch.py file_name:=/home/darsh/Downloads/5_support_plane_debug_cloud.pcd

# See the objects cloud that was extracted from the point cloud
ros2 launch ur_mtc_pick_place_demo point_cloud_viewer.launch.py file_name:=/home/darsh/Downloads/5_objects_cloud_debug_cloud.pcd
