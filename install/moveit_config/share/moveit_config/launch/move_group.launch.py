...
def generate_launch_description():
    """
    Generate a launch description for MoveIt 2 with handbot robot.

    This function sets up the necessary configuration and nodes to launch MoveIt 2
    for controlling a handbot robotic arm. It includes setting up paths to config files,
    ...
    def configure_setup(context):
        ...
        srdf_model_path = os.path.join(config_path, 'ur.srdf')
