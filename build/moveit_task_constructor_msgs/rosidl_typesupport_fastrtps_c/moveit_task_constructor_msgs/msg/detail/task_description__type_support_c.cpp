...
bool cdr_serialize_moveit_task_constructor_msgs__msg__TaskDescription(
  const moveit_task_constructor_msgs__msg__TaskDescription * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: task_id
  {
  ...
  // Field name: stages
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_moveit_task_constructor_msgs__msg__StageDescription(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_task_constructor_msgs
bool cdr_deserialize_moveit_task_constructor_msgs__msg__TaskDescription(
  eprosima::fastcdr::Cdr & cdr,
  moveit_task_constructor_msgs__msg__TaskDescription * ros_message)
{
  // Field name: task_id
  {
    std::string tmp;
  ...
  // Field name: stages
  {
    ...
    auto array_ptr = ros_message->stages.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_moveit_task_constructor_msgs__msg__StageDescription(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_task_constructor_msgs
bool cdr_serialize_key_moveit_task_constructor_msgs__msg__TaskDescription(
  const moveit_task_constructor_msgs__msg__TaskDescription * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: task_id
  ...
  // Field name: stages
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_moveit_task_constructor_msgs__msg__StageDescription(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_task_constructor_msgs
size_t get_serialized_size_key_moveit_task_constructor_msgs__msg__TaskDescription(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TaskDescription__ros_msg_type * ros_message = static_cast<const _TaskDescription__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: stages
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_moveit_task_constructor_msgs__msg__StageDescription(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_moveit_task_constructor_msgs
size_t max_serialized_size_key_moveit_task_constructor_msgs__msg__TaskDescription(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: stages
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_moveit_task_constructor_msgs__msg__StageDescription(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const moveit_task_constructor_msgs__msg__TaskDescription * ros_message = static_cast<const moveit_task_constructor_msgs__msg__TaskDescription *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_moveit_task_constructor_msgs__msg__TaskDescription(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  moveit_task_constructor_msgs__msg__TaskDescription * ros_message = static_cast<moveit_task_constructor_msgs__msg__TaskDescription *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_moveit_task_constructor_msgs__msg__TaskDescription(cdr, ros_message);
}
