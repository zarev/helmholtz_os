...
EXPECT_X="${EXPECT_X:-1.43}"
EXPECT_Y="${EXPECT_Y:--0.58}"
EXPECT_Z="${EXPECT_Z:-0.75}"
EXPECT_QX="${EXPECT_QX:--0.20}"
EXPECT_QY="${EXPECT_QY:-0.05}"
EXPECT_QZ="${EXPECT_QZ:-0.95}"
EXPECT_QW="${EXPECT_QW:-0.23}"
