  ...
  : Node("mtc_node", options)
{
  ...
  declare_parameter("object_dimensions", std::vector<double>{1.0, 0.022}, "Dimensions of the object [height, radius]");
...
declare_parameter("grasp_frame_transform", 
  std::vector<double>{-0.05, 0.0, 0.15, 0.0, 1.5708, 0.0}, "Transform from gripper frame to grasp frame [x, y, z, roll, pitch, yaw]");
