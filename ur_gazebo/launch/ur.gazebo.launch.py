...
from launch_ros.actions import PythonLaunchDescriptionSource

def generate_launch_description():
    # Define package names for different components
    ...
    ros_gz_bridge_config_file_path = 'ros_gz_bridge_config.yaml'
    ...
    load_controllers_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(pkg_share_moveit, 'launch', 'load_ros2_controllers.launch.py')]),
